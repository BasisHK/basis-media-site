...
(function () {
  ...
  var dict = {
    en: {
      ...
      "contact.formNote": "Sends securely to business@basis.hk. We'll reply within one business day.",
      "contact.sending": "Sending…",
      "contact.success": "Brief sent. We'll get back within one business day.",
      "contact.err.required": "Please fill in name, email, and brief.",
      "contact.err.send": "Could not send. Please email business@basis.hk.",
    ...
    zh: {
      ...
      "contact.formNote": "會安全傳送到 business@basis.hk。我哋通常一個工作天內回覆。",
      "contact.sending": "傳送緊…",
      "contact.success": "Brief 已送出。我哋會喺一個工作天內回覆。",
      "contact.err.required": "請填寫姓名、電郵同 brief。",
      "contact.err.send": "傳送失敗。請直接電郵 business@basis.hk。",
      "contact.ph.name": "你嘅名",
      "contact.ph.email": "you@brand.com",
